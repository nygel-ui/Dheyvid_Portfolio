            ...
            <div className="w-full flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                >
                    ...
                    <p className="text-gray-300 text-base sm:text-lg md:text-2xl leading-relaxed">
                        I'm Dheyvid Kyle Pe — a front-end developer, UI/UX designer, and multimedia creator. I love crafting websites, designing smooth user experiences, and creating visuals and videos that tell a story.
                    </p>
                </div>
            </div>
